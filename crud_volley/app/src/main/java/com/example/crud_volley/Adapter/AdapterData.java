...
// class AdapterData mewarisi class RecycleView.Adapter
// Adaptor menyediakan data set aplikasi khusus ke tampilan yang ditampilkan dalam RecyclerView
	 	...
	 	public HolderData( View view){
	 		...
	 		view.setOnClickListener(new View.OnClickListener(){
			  ...
			  public void onClick( View view){
	 				Intent update = new Intent(context, com.example.crud_volley.InsertData.class);
