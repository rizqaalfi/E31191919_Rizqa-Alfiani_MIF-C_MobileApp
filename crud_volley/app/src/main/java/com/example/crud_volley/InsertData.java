...
//inisialsialisasi edittext dan button sesuai yang ada pada layout_insert_data
	...
	pd = new ProgressDialog(com.example.crud_volley.InsertData.this);
...
//	update atau insert
	...
	btnbatal.setOnClickListener(new View.OnClickListener() {
		@Override
		public void onClick(View view) {
			Intent main = new Intent(com.example.crud_volley.InsertData.this,MainActivity.class);
			startActivity(main);
		}
	});
}
	...
	StringRequest updateReq = new StringRequest(Request.Method.POST, ServerAPI.URL_UPDATE,
					new Response.Listener<String>() {
						...
						public void onResponse(String response) {
							...
							try {
								...
								Toast.makeText(com.example.crud_volley.InsertData.this, "pesan : "+   res.getString(
												"message") , Toast.LENGTH_SHORT).show();
							} catch (JSONException e) {
								e.printStackTrace();
							}

							startActivity( new Intent(com.example.crud_volley.InsertData.this,
											MainActivity.class));
						}
					},
					new Response.ErrorListener() {
						...
						public void onErrorResponse(VolleyError error) {
							pd.cancel();
							Toast.makeText(com.example.crud_volley.InsertData.this, "pesan : Gagal Insert Data",
